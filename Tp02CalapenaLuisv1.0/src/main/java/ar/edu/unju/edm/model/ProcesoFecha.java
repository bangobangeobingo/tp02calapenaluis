...
public class ProcesoFecha {
	...
	//Constructor sobrecargado con parámetros (LocalDate fecha1, LocalDate fecha2).
	public ProcesoFecha(LocalDate fecha1, LocalDate fecha2) {
		super();
		this.fecha1 = fecha1;
		this.fecha2 = fecha2;
	}
	//Constructor sobrecargado con parámetros (LocalTime time1, LocalTime time2).
	public ProcesoFecha(LocalTime time1, LocalTime time2) {
		super();
		this.time1 = time1;
		this.time2 = time2;
	}
	//Constructor sobrecargado con parámetros (LocalDateTime dateTime1, LocalDateTime dateTime2).
	public ProcesoFecha(LocalDateTime dateTime1, LocalDateTime dateTime2) {
		super();
		this.dateTime1 = dateTime1;
		this.dateTime2 = dateTime2;
	}
	//Agregando métodos get y set para poder acceder a los datos de los atributos.
    ...
    //Declare los siguientes metodos dentro de la clase ProcesoFecha:
	...
	public String compararFechas() {
		   String resultadoComparar="";
		if(fecha1.compareTo(fecha2) > 0) {
			resultadoComparar=("La fecha "+fecha1+" es posterior a la fecha "+fecha2);
		}else if(fecha1.compareTo(fecha2) < 0) {
			resultadoComparar=("La fecha "+fecha1+" es anterior a la fecha "+fecha2);
		}else if(fecha1.compareTo(fecha2) == 0) {
			resultadoComparar="Las fechas son iguales";
		}
